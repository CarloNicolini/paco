...
#ifndef _Asymptotic_ModularityFunction_H
#define _Asymptotic_ModularityFunction_H

#include "QualityFunction.h"

class AsymptoticModularityFunction : public QualityFunction
{
public:
    AsymptoticModularityFunction();
    ~AsymptoticModularityFunction() {}
...
#endif // _Asymptotic_ModularityFunction_H
