...
#ifndef CORRELATIONMODULARITYFUNCTION_H
#define CORRELATIONMODULARITYFUNCTION_H

#include "QualityFunction.h"
class CorrelationModularityFunction
{
public:
    CorrelationModularityFunction();
    ~CorrelationModularityFunction(){}
...
#endif // CORRELATIONMODULARITYFUNCTION_H
