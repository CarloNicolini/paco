...
#ifndef DegreeCorrectedSurpriseFunction_H
#define DegreeCorrectedSurpriseFunction_H

#include "QualityFunction.h"
#include "Surprise.h"

class DegreeCorrectedSurpriseFunction : public QualityFunction
{
public:
    DegreeCorrectedSurpriseFunction();
    ~DegreeCorrectedSurpriseFunction() {}
...
#endif // DegreeCorrectedSurpriseFunction_H
